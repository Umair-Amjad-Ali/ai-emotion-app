import 'dart:ui';
import 'package:ai_emotion_app/screen/guiltcleanser/sorting_weight_screen_step_three.dart';
...
class WeightOnHeartScreen extends StatefulWidget {
  const WeightOnHeartScreen({super.key});

  @override
  State<WeightOnHeartScreen> createState() => _WeightOnHeartScreenState();
}

class _WeightOnHeartScreenState extends State<WeightOnHeartScreen> {
                      ...
                      PrimaryButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  const SortingWeightScreenStepThree(),
                            ),
                          );
                        },
                      ),
